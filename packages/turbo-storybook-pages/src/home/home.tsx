...
import { Button, Quote } from '@turbo-storybook/design-system'
import { matchingTextColor, randomColor } from '@turbo-storybook/utils/function'
...
export default function Home() {
  ...
  return (
    <Page>
      ...
      <Text variant="h2" className="mt-10 mb-6">
        packages/turbo-storybook-design-system
      </Text>
      <Text className="mb-4">
      ...
      <Quote className="mt-4 mb-4">
        This is the <Code>Quote</Code> component in the design system.
      </Quote>
      <Text variant="h2" className="mt-10 mb-6">
        packages/turbo-storybook-pages
      </Text>
      <Text className="mb-4">
        Works in the same way as{' '}
        <Code>packages/turbo-storybook-design-system</Code> but instead of
        building a design system it&apos;s about having shared components that
        represent pages.
      </Text>
      <Text className="mb-4">
        You&apos;re currently looking at the Home page, defined in{' '}
        <Code>packages/turbo-storybook-pages/src/home</Code> and imported by{' '}
        <Code>apps/main/pages/index.tsx</Code>.
      </Text>
      <Text variant="h2" className="mt-10 mb-6">
        packages/turbo-storybook-utils
      </Text>
      ...
      <Text variant="h2" className="mt-10 my-6">
        packages/turbo-storybook-storybook
      </Text>
      <Text className="mb-4">
        This packages takes the stories in{' '}
        <Code>packages/turbo-storybook-design-system</Code> and opens them in{' '}
      ...
      <Text variant="h2" className="mt-10 my-6">
        packages/eslint-config-turbo-storybook
      </Text>
      <Text className="mb-4">
