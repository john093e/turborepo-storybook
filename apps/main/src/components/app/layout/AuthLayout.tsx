...
import Decor from "@components/app/layout/Decor";
...
const AuthLayout = ({ pageTitle, pageDescription, children }: LayoutProps) => {
  const logo = "/favicon.ico";
  return (
    <>
      <div className="min-h-screen bg-gray-100 flex flex-col sm:justify-center">
        <Head>
        ...
        <section className="bg-white dark:bg-gray-900 h-full relative">
          <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
            <section className="relative flex h-52 sm:h-64 md:h-96 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
