...
export default function Defaults({ userId }: PropForm) {
  ...
  } = api.adminSettingsAccountDefaultsAccountDefaults.getAccountSettings.useQuery(
    {
  ...
  // get data for form 2
  const {
    data: accountNGOSettings,
    isLoading: isLoadingAccountNGOSettings,
    refetch: refetchAccountNGOSettings,
  } = api.adminSettingsAccountDefaultsAccountDefaults.getAccountNGOSettings.useQuery(
    {
      userId: userId as string,
    },
    {
  ...
  const {
    ...
    isLoading: isLoadingUpdateAccountSettings,
  } =
    api.adminSettingsAccountDefaultsAccountDefaults.updateAccountSettings.useMutation(
      {
        onSuccess(data) {
  ...
  // function Update Account settings
  const {
    mutate: updateAccountNGOSettings,
    isLoading: isLoadingUpdateAccountNGOSettings,
  } =
    api.adminSettingsAccountDefaultsAccountDefaults.updateAccountNGOSettings.useMutation(
      {
        onSuccess(data) {
          refetchAccountNGOSettings()
          setSaving(false)
          setDataInForm2Updated(!dataInForm2Updated)
          toast.success(`Changes Saved`, {
            position: 'top-right',
  ...
  return (
    <>
      ...
      <div className="flex-row lg:flex">
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-gray-800 dark:text-gray-400 text-sm">
            This information will be used as a default where needed. If you’re
            looking to update your company information for billing, visit{' '}
      ...
      Object.keys(formStateAccountNGOPreferences.dirtyFields).length > 0 ? (
